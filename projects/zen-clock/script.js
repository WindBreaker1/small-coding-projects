...
function changeBackground() {
  switch (bg) {
    case '1':
      document.body.style.backgroundImage = "url('assets/rain1.gif')";
      document.body.style.backgroundRepeat = "no-repeat";
      document.body.style.backgroundSize = "110%";
      bg = '2';
      break;
    case '2':
      document.body.style.backgroundImage = "url('assets/rain2.gif')";
      document.body.style.backgroundRepeat = "no-repeat";
      document.body.style.backgroundSize = "150%";
      bg = '3';
      break;
    case '3':
      document.body.style.backgroundImage = "url('assets/rain3.gif')";
      document.body.style.backgroundRepeat = "no-repeat";
